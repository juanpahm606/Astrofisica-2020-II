# -*- coding: utf-8 -*-
"""
Created on Sat Sep 19 23:40:44 2020
...
data = parse_single_table('ic 4665-c-result.vot').array
...
E     = 0.174                     # Valor del reddening (tomado de WEBDA)
...
plt.title('Color-Magnitud Diagram - IC 4665')
plt.grid()
